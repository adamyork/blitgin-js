...
Player = (function(_super) {
  ...
  Player.prototype.updatePoints = function() {
    if (this.composite !== void 0) {
      this.composite.point = this.compositePoint;
    }
    if (this.emitter !== void 0) {
      return this.emitter.point = this.emitterPoint;
    }
  };
...
Player.prototype.__defineGetter__("hOrigin", function() {
  ...
  val = 0;
  dir = this.direction;
  if (this.directionOfCollision !== void 0) {
    dir = this.directionOfCollision;
  }
  if (dir === -1) {
    val = this.x;
  } else if (dir === 1) {
...
Player.prototype.__defineSetter__("state", function(val) {
  if (this._isBusy || (this._state.id === val.id)) {
    return;
  }
